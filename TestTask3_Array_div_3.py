...
# Menu: you may choose version for operation with arrays between manual and auto
print('Please choose Version for operation with array. Enter 1 (manual) or 2 (auto)')
